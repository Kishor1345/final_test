// Package controllersnoc contains data structures and controller logic for the NOC Template page.
//
...
type APIResponseForNocTemplate struct {
...
// Request structure
type NocTemplateRequest struct {
	Data string `json:"Data"`
}

// Handler function
func NocTemplateHandler(w http.ResponseWriter, r *http.Request) {
	...
	auth.LogRequestInfo(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		// Call database layer
		data, totalCount, err := database.NocTemplateDatabase(decryptedData)
		if err != nil {
		...
		response := APIResponseForNocTemplate{
			Data:    responseData,
			P_id:    pid,
			Status:  200,
			Message: "Success",
