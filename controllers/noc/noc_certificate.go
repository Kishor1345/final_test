// Package controllersnoc contains data structures and database access logic for the NOC Certificate master page.
//
...
type APIResponseForNocCertificate struct {
...
// Request structure
type NocCertificateRequest struct {
	Data string `json:"Data"`
}


// Handler function
func NocCertificateHandler(w http.ResponseWriter, r *http.Request) {
	...
	auth.LogRequestInfo(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		// Call database layer
		data, totalCount, err := database.NocCertificateDatabase(decryptedData)
		if err != nil {
		...
		response := APIResponseForNocCertificate{
			Data:    responseData,
			P_id:    pid,
			Status:  200,
			Message: "Success",
