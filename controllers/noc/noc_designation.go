// Package controllersnoc contains data structures and controller logic for the NOC Designation page.
//
...
type APIResponseForNocDesignation struct {
...
// Request structure
type NocDesignationRequest struct {
	Data string `json:"Data"`
}


// Handler function
func NocDesignationHandler(w http.ResponseWriter, r *http.Request) {
	...
	auth.LogRequestInfo(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		// Call database layer
		data, totalCount, err := database.NocDesignationDatabase(decryptedData)
		if err != nil {
		...
		response := APIResponseForNocDesignation{
			Data:    responseData,
			P_id:    pid,
			Status:  200,
			Message: "Success",
