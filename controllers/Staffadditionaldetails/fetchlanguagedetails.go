...
type EmployeeLanguageDetailsRequest struct {
...
// Handler to fetch EmployeeLanguageDetailsHandler details
func EmployeeLanguageDetailsHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Parse JSON request
	var req EmployeeLanguageDetailsRequest
	...
	data, err := databasesad.FetchEmployeeLanguageDetails(employeeID)
	if err != nil {
