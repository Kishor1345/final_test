...
type EmployeeExperienceDetailsRequest struct {
...
// Handler to fetch EmployeeExperienceDetailsHandler details
func EmployeeExperienceDetailsHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Parse JSON request
	var req EmployeeExperienceDetailsRequest
	...
	data, err := databasesad.FetchEmployeeExperienceDetails(employeeID)
	if err != nil {
