...
type EmployeeEducationDetailsRequest struct {
...
// Handler to fetch EmployeeEducationDetailsHandler details
func EmployeeEducationDetailsHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Parse JSON request
	var req EmployeeEducationDetailsRequest
	...
	data, err := databasesad.FetchEmployeeEducationDetails(employeeID)
	if err != nil {
