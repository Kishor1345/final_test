...
type EmployeeNomineeDetailsRequest struct {
	Data string `json:"Data"`
}

// Standard API response structure
type NomineeAPIResponse struct {
	Status  int         `json:"Status"`
	Message string      `json:"message"`
	Data    interface{} `json:"Data"`
}

// Handler to fetch NomineeDetails details
func EmployeeNomineeDetailsHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Parse JSON request
	var req EmployeeNomineeDetailsRequest
	...
	data, err := databasesad.FetchEmployeeNomineeDetails(employeeID)
	if err != nil {
