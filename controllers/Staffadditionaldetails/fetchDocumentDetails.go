...
type EmployeeDocumentDetailsRequest struct {
...
// Handler to fetch employee document details
func EmployeeDocumentDetailsHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Parse JSON request
	var req EmployeeDocumentDetailsRequest
	...
	data, err := databasesad.FetchEmployeeDocumentDetails(employeeID)
	if err != nil {
