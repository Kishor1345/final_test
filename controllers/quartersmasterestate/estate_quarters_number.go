// Package controllersquartersmasterestate handles HTTP APIs for Estate Quarters Number Dropdown API.
//
...
type APIResponseEstateQuartersNumberDropdown struct {
...
// Request structure
type EstateQuartersNumberDropdownRequest struct {
	Data string `json:"Data"`
}


// EstateQuartersNumberDropdown — Controller handler
func EstateQuartersNumberDropdown(w http.ResponseWriter, r *http.Request) {
	...
	var req EstateQuartersNumberDropdownRequest
	...
	auth.LogRequestInfo(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		// DB call
		data, totalCount, err := databasequartersmasterestate.GetEstateQuartersNumberDropdownFromDB(decryptedData)
		if err != nil {
		...
		// Response formatting
		response := APIResponseEstateQuartersNumberDropdown{
			Status:  200,
			Message: "Success",
