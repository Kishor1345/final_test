// Package controllersquartersmasterestate handles HTTP APIs for Quarter Category Dropdown API.
//
...
type APIResponseQuarterCategoryDropdown struct {
...
// Request structure
type QuarterCategoryDropdownRequest struct {
	Data string `json:"Data"`
}

// QuarterCategoryDropdown — Controller handler
func QuarterCategoryDropdown(w http.ResponseWriter, r *http.Request) {
	...
	var req QuarterCategoryDropdownRequest
	...
	auth.LogRequestInfo(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		// DB call
		data, totalCount, err := databasequartersmasterestate.GetQuarterCategoryDropdownFromDB(decryptedData)
		if err != nil {
		...
		// Response formatting
		response := APIResponseQuarterCategoryDropdown{
			Status:  200,
			Message: "Success",
