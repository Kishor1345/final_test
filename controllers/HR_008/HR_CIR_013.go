...
type APIResponseCircularDetailDataFetch struct {
...
type CircularDetailFetchRequest struct {
	Data string `json:"Data"`
}

// CriteriaMasterDataFetchForApproval handles fetching Criteria Master data for approval
func CircularDetailFetch(w http.ResponseWriter, r *http.Request) {
	...
	var req CircularDetailFetchRequest
	...
	auth.LogRequestInfo(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		data, totalCount, err := databasecircular.DatabaseCircularDetailFetch(decryptedData)
		if err != nil {
		...
		// Response format:
		response := APIResponseCircularDetailDataFetch{
			Status:  200,
			Message : "Circular details fetched successfully",
