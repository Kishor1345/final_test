//package controllerscircular contains data structures and database access logic for the Quarters Number Fetch.
//
...
type APIResponseQuartersNumberDataFetch struct {
...
type CircularQuartersNumberRequest struct {
	Data string `json:"Data"`
}

// CriteriaMasterDataFetchForApproval handles fetching Criteria Master data for approval
func CircularQuartersNumber(w http.ResponseWriter, r *http.Request) {
	...
	var req CircularQuartersNumberRequest
	...
	auth.LogRequestInfo(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		data, totalCount, err := databasecircular.DatabaseQuartersNumberFetch(decryptedData)
		if err != nil {
		...
		// Response format:
		response := APIResponseQuartersNumberDataFetch{
			Status:  200,
