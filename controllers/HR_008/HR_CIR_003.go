//package controllerscircular contains data structures and database access logic for the Eligibility_Choice_Data for approval.
//
...
type APIResponseEligibilityChoiceDataFetch struct {
...
type CircularEligibilityChoiceRequest struct {
	Data string `json:"Data"`
}

// CriteriaMasterDataFetchForApproval handles fetching Criteria Master data for approval
func CircularEligibilityChoice(w http.ResponseWriter, r *http.Request) {
	...
	var req CircularEligibilityChoiceRequest
	...
	auth.LogRequestInfo(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		data, totalCount, err := databasecircular.CircularDataFetchForEligibilityChoice(decryptedData)
		if err != nil {
		...
		// Response format:
		response := APIResponseEligibilityChoiceDataFetch{
			Status:  200,
