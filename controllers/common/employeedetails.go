// Package controllerscommon contains data structures and database access logic for the Employeedetails page.
//
...
type EmployeeDetailsRequest struct {
...
func Employeedetails(w http.ResponseWriter, r *http.Request) {
	...
	var req EmployeeDetailsRequest
	...
	auth.LogRequestInfo(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		data, totalCount, err := database.EmployeeDetailsdatabase(decryptedData)
		if err != nil {
