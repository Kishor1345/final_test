// Package controllerscommon contains structs and queries for DepartmentMaster.
...
// Last Modified By:  
// Last Modified Date: 
// This api is to fetch the all DepartmentMaster.
...
// APIResponseDepartmentMaster defines the structure of the JSON response
type APIResponseDepartmentMaster struct {
...
// DepartmentMasterRequest defines the expected request structure
type DepartmentMasterRequest struct {
	Data string `json:"Data"`
}

// DepartmentMasterDecryptedRequestData defines the structure of decrypted data
type DepartmentMasterDecryptedRequestData struct {
	Token string `json:"token"`
	PId   string `json:"P_id"`
}

//DepartmentMaster handles the Bank Master API request.
func DepartmentMaster(w http.ResponseWriter, r *http.Request) {
	...
	var req DepartmentMasterRequest
	...
	// Unmarshal encrypted request wrapper
	var decryptedData DepartmentMasterDecryptedRequestData
	...
	//Business logic - fetch DepartmentMaster data
	data, err := databasesad.GetDepartmentMaster()
	if err != nil {
	...
	response := APIResponseDepartmentMaster{
		Status:  200,
		Message: "Success",
		Data:    data,
